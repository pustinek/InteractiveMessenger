package me.pustinek.interactivemessenger.parsers;
...
import me.pustinek.interactivemessenger.message.InteractiveMessagePart;
import me.pustinek.interactivemessenger.message.TextMessagePart;
import me.pustinek.interactivemessenger.message.enums.Click;
import me.pustinek.interactivemessenger.message.enums.Color;
import me.pustinek.interactivemessenger.message.enums.Control;
import me.pustinek.interactivemessenger.message.enums.Hover;
import me.pustinek.interactivemessenger.message.enums.Format;
...
public class YamlParser {
	...
	private static TaggedContent getNextTag(String line) {
		...
		while(matcher.find()) {
			...
			if (matcher.group().equals("\\n")) {
				...
				tag = Color.HEX;
				content = matcher.group().substring(1); // Extract the hex value without &
			}
			else if (matcher.group().startsWith("&") || matcher.group().startsWith(COLOR_CHAR + "")) {
	...
	private static final List<String> toEscape = Arrays.asList(
			...
			COLOR_CHAR+"" // Legacy formatting enums
	);
